...
export type UiIconName = "plus" | "folder" | "chevron" | "pin" | "edit" | "external" | "trash" | "copy" | "more" | "settings" | "runtime" | "panel" | "compact" | "status" | "check" | "warning" | "todo" | "pause" | "stop" | "send" | "eye" | "eye-off" | "minimize" | "floating" | "maximize" | "focus" | "file";
...
export function UiIcon({ name }: { name: UiIconName }) {
  const paths: Record<UiIconName, ReactNode> = {
    ...
    file: <><path d="M4 2.75h5l3 3v7.5H4z" /><path d="M9 2.75v3h3M5.75 8h4.5M5.75 10.25h4.5" /></>,
